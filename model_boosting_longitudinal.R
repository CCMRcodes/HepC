# This code performs longitudinal boosting survival model with 30 random splits of training/test data.
...
result_lgt <- result
result_iter_lgt <- result_iter
result_importance_lgt <- result_importance
# Save results